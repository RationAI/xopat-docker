...
//LOCALHOST
define('SERVED_IMAGES', PROTOCOL . "localhost/iipsrv.fcgi");
define('SERVED_LAYERS', PROTOCOL . "localhost/iipsrv.fcgi");

define('COMMON_HEADERS', array("Access-Control-Allow-Origin" => "*"));
define('AUTH_HEADERS', isset($_SERVER['HTTP_AUTHORIZATION']) ? $_SERVER['HTTP_AUTHORIZATION'] : false);  //unused now
